...
function saveToGetQuestionNode(classid, className, Name, info, hh, mm, ymd) {
	if(questionList.questionContent != "") {
		localStorage.setItem("lastname", JSON.stringify(questionList));
...
function getClass() {
	if(typeof(Storage) !== "undefined") {
		...
		var className = localStorage.getItem('className', className);
		var Name = localStorage.getItem('Name', Name);
		var info = localStorage.getItem('info', info);
		var hh = localStorage.getItem('hh', hh);
		var mm = localStorage.getItem('mm', mm);
		var ymd = localStorage.getItem('ymd', ymd);
...
//					a1+="<tr><td>D:&nbsp&nbsp"+subjectlist.content[i].questionNode.option_d+"</td></tr>";
		...
		a1 += "<div class='subject_info' style='display: none;'><div class='info_1'><span>【答案】</span><span>" + subjectlist.content[i].questionNode.answer1 + "</span></div><div class='info_2'><span>【解析】</span><div class='info_2_div'>" + subjectlist.content[i].questionNode.parse + "</div></div><div class='info_3'><span> 【知识点】</span><div class='info_3_div'><p></p></div></div><div class='info_4'><span>【题型】</span><span class='info_4_span'>" + subjectlist.content[i].questionNode.qtpye + "</span></div></div>"
		a1 += "</div></div>";
...
function Chapter_click() {
	...
	$.ajax({
		url: "http://192.168.31.154:8888/QUESTIONSREPOSITORY/question/getQuestionsExtraByKnowledge",
		headers: {
...
function edition_click(obj, editionid) {
	...
	$.ajax({
		url: "http://192.168.31.154:8888/QUESTIONSREPOSITORY/question/getChapterInfo",
		headers: {
			'accessToken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1c2VySW5mbyI6IntcImNsYXNzSWRcIjpcIjc3N1wiLFwidGltZVN0YW1wXCI6MTUzOTMxNzIzMTE2NCxcInVzZXJJZFwiOlwiMTIzXCIsXCJ1c2VyTmFtZVwiOlwi5byg5LiJXCIsXCJ1c2VyTnVtXCI6XCI0NTZcIn0ifQ.BXQaa-JsFEBCB0tECtY1fjWhxxEbzlPwADsRRN2rvo-sW_n6OvRrEKvmpsdq75zkxeSvdeiYXfzX9SG_6yERKg'
		},
		type: 'post',
...
function inits() {
	$.ajax({
		url: "http://192.168.31.154:8888/QUESTIONSREPOSITORY/question/getOtherBasicInfo",
		headers: {
			'accessToken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1c2VySW5mbyI6IntcImNsYXNzSWRcIjpcIjc3N1wiLFwidGltZVN0YW1wXCI6MTUzOTMxNzIzMTE2NCxcInVzZXJJZFwiOlwiMTIzXCIsXCJ1c2VyTmFtZVwiOlwi5byg5LiJXCIsXCJ1c2VyTnVtXCI6XCI0NTZcIn0ifQ.BXQaa-JsFEBCB0tECtY1fjWhxxEbzlPwADsRRN2rvo-sW_n6OvRrEKvmpsdq75zkxeSvdeiYXfzX9SG_6yERKg'
		},
		type: 'get',
	...
	$.ajax({
		url: "http://192.168.31.154:8888/QUESTIONSREPOSITORY/question/getSubjectEditionInfoByTeacher",
		headers: {
			'accessToken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1c2VySW5mbyI6IntcImNsYXNzSWRcIjpcIjc3N1wiLFwidGltZVN0YW1wXCI6MTUzOTMxNzIzMTE2NCxcInVzZXJJZFwiOlwiMTIzXCIsXCJ1c2VyTmFtZVwiOlwi5byg5LiJXCIsXCJ1c2VyTnVtXCI6XCI0NTZcIn0ifQ.BXQaa-JsFEBCB0tECtY1fjWhxxEbzlPwADsRRN2rvo-sW_n6OvRrEKvmpsdq75zkxeSvdeiYXfzX9SG_6yERKg'
		},
		type: 'get',
