	...
	if(itembaklist.content.length > 0) {
		...
		//if(isWhichoneItem == 3) {
			for(var i = 0; i < itembaklist.content.length; i++, num++) {
				...
				a1 += "<div class='subjectOperation' style='margin-left:620px;'><a onclick='add_paper(this,2)' class='subjectOperation_add' style='margin-top:20xp;line-height:17px;"+(!added?"display:inline-block;":"display:none;")+"'>加入试卷</a><a  onclick='remove_paper(this)' class='subjectOperation_remove' style='margin-top:20xp;line-height:17px;"+(added?"display:inline-block;":"display:none;")+"'>移除试卷</a>";
				if(isWhichoneItem == 3) {
