...
function Loadlist(years, questionType, difficultyType, paperType, areas) {
	...
	var j = 0;
	var html = "<div style='position:relative;vertical-align:top;display:inline-block;width:92%'>";
