$(function() {
	function con() {
		$.ajax({
			...
			url: "http://192.168.31.108:8888/QUESTIONSREPOSITORY/question/getKnowledgeInfoByTeacher",
			headers: {
				'accessToken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1c2VySW5mbyI6IntcInRpbWVTdGFtcFwiOjE1MzkyNDUzODQzMDYsXCJ1c2VySWRcIjpcIjEyM1wiLFwidXNlck5hbWVcIjpcIuW8oOS4iVwifSJ9.Vdc-5R7I3I-EGriPu9ytbdAKt_X21HrSnLNoqS-TANQ6OALuFEasWhnbOoG5_wJmHA__nDgVHeN6DSxjJZ1Biw'
			},
			type: "get",
			async: false,
			dataType: "json",
